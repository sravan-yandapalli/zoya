...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        await transporter.sendMail({
            ...
            html: `<p>Dear ${name},</p>
                   <p>Thank you for reaching out to Zoya Homeo Care! Our team will get back to you shortly to confirm your booking.</p>
                   <p>Your appointment details:</p>
                   <ul>
                       <li><strong>Date:</strong> ${date}</li>
                       <li><strong>Time:</strong> ${time}</li>
                   </ul>
                   <p>If you need urgent assistance, call us at <strong>7075367929</strong>.</p>`,
        });
